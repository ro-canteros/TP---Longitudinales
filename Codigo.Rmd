...
m5 <- lme(afcr ~ 1 + previo + edad + mes + previo:mes + edad:mes + grupo:mes +
            previo:edad:mes + previo:grupo:mes + edad:grupo:mes,
          random = ~ 1|id, weights = varIdent(form = ~ 1|grupo),
          data = esclerosis)
summary(m5)
...
m1_1 <- update(m1, fixed = ~ 1 + previo + mes + previo:mes + edad:mes + grupo:mes + 
...
anova(m1, m1_1) #Rechazo H0 ---> el nivel de AFCR antes de inciar se ve afectado por la edad
anova(m1, m1_2) # Rechazo H0 ---> Idem. anterior pero para trat. previo
```
