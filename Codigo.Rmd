...
Se observa mucha variabilidad INTRA individuos (se observan mucho picos) y paraceria haber variancias similares entre ambos grupos. Además las tendencias cambian después del mes 3 (grupo 1 subem grupo 2 baja); si bien los valores de AFCR medio para el grupo 1 (solo azatioprina) son mayores que para grupo 2, ambos grupos tienen una tendencia lineal decreciente.
...
```
La variancia parece ser menor a medida que los meses pasan pero no pareciera diferir tanto entre los grupos.
...
# Gráfico
graf_3 <- ggplot(correlog, aes(x = rezago, y = ac, group = grupo, color = grupo)) +
  geom_point(size = 2) +
  geom_line(size = 1) +
